...
{
    /// <summary>
    /// Base class for commands that don't require a Jira client
    /// </summary>
    public abstract class BaseStandaloneCommand : ICommand
    {
        protected readonly CommandLineOptions _options;
        protected readonly ILogger _logger;

        protected BaseStandaloneCommand(CommandLineOptions options, ILogger logger = null)
        {
